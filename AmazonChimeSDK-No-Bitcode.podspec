Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://amazon-chime-sdk-ios.s3.amazonaws.com/sdk-without-bitcode/0.23.0/AmazonChimeSDK-0.23.0.tar.gz" }
  s.ios.deployment_target = '11.0'
  s.vendored_frameworks = "AmazonChimeSDK.xcframework"
  s.swift_version    = '5.0'
  s.dependency 'AmazonChimeSDKMedia-No-Bitcode', '0.18.0'
end
