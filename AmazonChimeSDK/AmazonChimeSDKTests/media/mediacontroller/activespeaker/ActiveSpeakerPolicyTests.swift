...
class ActiveSpeakerPolicyTests: XCTestCase {
    private var activeSpeakerPolicy: DefaultActiveSpeakerPolicy = DefaultActiveSpeakerPolicy(speakerWeight: 0.9, cutoffThreshold: 0.01, takeoverRate: 0.2)
    private var attendeeA: AttendeeInfo = AttendeeInfo(attendeeId: "fakeAttendeeIdA", externalUserId: "fakeExternalUserIdA")
    private var attendeeB: AttendeeInfo = AttendeeInfo(attendeeId: "fakeAttendeeIdB", externalUserId: "fakeExternalUserIdB")
    ...
    override func setUp() {
        super.setUp()
        activeSpeakerPolicy = DefaultActiveSpeakerPolicy(speakerWeight: speakerWeight, cutoffThreshold: cutoffThreshold, takeoverRate: takeoverRate)
    }
