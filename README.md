 ...
 * if you do NOT need bitcode support:
    * [AmazonChimeSDK-0.8.2.tar.gz](https://amazon-chime-sdk-ios.s3.amazonaws.com/sdk-without-bitcode/0.8.2/AmazonChimeSDK-0.8.2.tar.gz)
    * [AmazonChimeSDKMedia-0.6.1.tar.gz](https://amazon-chime-sdk-ios.s3.amazonaws.com/media-without-bitcode/0.6.1/AmazonChimeSDKMedia-0.6.1.tar.gz)
