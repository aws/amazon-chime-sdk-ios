Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://amazon-chime-sdk-ios.s3.amazonaws.com/sdk-without-bitcode/0.22.2/AmazonChimeSDK-0.22.2.tar.gz" }
  s.ios.deployment_target = '10.0'
  s.vendored_frameworks = "AmazonChimeSDK.xcframework"
  s.swift_version    = '5.0'
  s.dependency 'AmazonChimeSDKMedia-No-Bitcode', '~> 0.17.6'
end
