...
typedef enum
{
    AUDIO_CLIENT_TRANSPORT_UNKNOWN       = 0,
    AUDIO_CLIENT_TRANSPORT_WEBSOCKET     = 1, // deprecated
    AUDIO_CLIENT_TRANSPORT_UDP           = 2, // deprecated
    AUDIO_CLIENT_TRANSPORT_DTLS          = 3,
    AUDIO_CLIENT_TRANSPORT_WEBSOCKET_SSL = 4,
} audio_client_transport_mode_t;
...
typedef enum {
    ...
    AUDIO_CLIENT_STATUS_ENUM_END                            = 77 /* this should always be last */
