 ...
 * if you need bitcode support:
   * [AmazonChimeSDK-0.5.2.tar.gz](https://amazon-chime-sdk.s3.amazonaws.com/ios/amazon-chime-sdk/0.5.2/AmazonChimeSDK-0.5.2.tar.gz)
 ...
 * if you do NOT need bitcode support:
   * [AmazonChimeSDK-0.5.2.tar.gz](https://amazon-chime-sdk.s3.amazonaws.com/ios/amazon-chime-sdk-without-bitcode/0.5.2/AmazonChimeSDK-0.5.2.tar.gz)
